...
public class SpeakAndSpell {
	...
	public static void main(String[] args) {
		// 1. Use the speak method to say the word. "spell mandlebrot"
		int hiitsmenoelani= 0;
speak("spell supercalifragilisticexpialidocious");
		// 2. Catch the user's answer in a String
String speak = JOptionPane.showInputDialog(null, "what did the computer say?NO CHEAKING!!!!!");
...
JOptionPane.showMessageDialog(null, " you have "+hiitsmenoelani+"point.");
